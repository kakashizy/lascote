		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD LASCOTE BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] KAKASHI? Este é um recurso especial para o KAKASHI ❌',
					ownerB: '[❗] KAKASHI? Este é um recurso especial para o KAKASHI ❌',
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* Ângelo\n*YOUTUBE:* \n*WPP:* wa.me/+5598987851993\n*INSTA:* @__kakashi\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
